...
<div class="admin-overview-grid">
    ...
    <aside class="admin-overview-aside">
        ...
        @if($canManageUsers)<div class="admin-overview-shortcuts"><a class="admin-shortcut" href="{{ route('platform.settings') }}"><x-icon name="settings" size="18" /><span>{{ __('Publication settings') }}</span><x-icon name="chevron-right" size="16" /></a><a class="admin-shortcut" href="{{ route('payouts') }}"><x-icon name="arrow-up-right" size="18" /><span>{{ __('Writer earnings') }}</span><x-icon name="chevron-right" size="16" /></a></div>@endif
    </aside>
</div>
